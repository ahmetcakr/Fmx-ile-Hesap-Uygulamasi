...
begin
  ...
  begin
    ...
    begin
      ...
      lblKenar1.Text := 'Taban Uzunluðu :';
      lblKenar2.Text := 'Yükseklik :';
    end;
...
// Net kazanca faizi hesaplayýp yazdýran prosedür
...
begin
  // banka seçimine göre faiz oranýný güncelliyor
  if listitemAkbank.IsSelected then
  begin
    faizOraný := FaizOranýYüzdesi('Akbank');
  end
  else if listitemCeptetep.IsSelected then
  begin
    faizOraný := FaizOranýYüzdesi('Ceptetep');
  end
  else if listitemOdeabank.IsSelected then
  begin
    faizOraný := FaizOranýYüzdesi('Odeabank');
  end
  else if listitemYapýKredi.IsSelected then
  begin
    faizOraný := FaizOranýYüzdesi('Yapýkredi');
  end;
